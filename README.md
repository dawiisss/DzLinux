...
1. Head to the [Releases Page](https://github.com/dawiisss/DzLinux/releases/latest) and download `DzLinux-1.3.1.AppImage`.
2. Give the file executable permissions via your terminal:
   ```bash
   chmod +x DzLinux-1.3.1.AppImage
   ```
...
1. Download `dzlinux-1.3.1.tar.gz` from the [Releases Page](https://github.com/dawiisss/DzLinux/releases/latest).
2. Extract the archive:
   ```bash
   tar -xzf dzlinux-1.3.1.tar.gz -C ~/Games/
   ```
...
1. Download `dzlinux_1.3.1_amd64.deb` from the [Releases Page](https://github.com/dawiisss/DzLinux/releases/latest).
2. Install via the terminal:
   ```bash
   sudo dpkg -i dzlinux_1.3.1_amd64.deb
   sudo apt install -f
   ```
...
1. Download `dzlinux-1.3.1.x86_64.rpm` from the [Releases Page](https://github.com/dawiisss/DzLinux/releases/latest).
2. Install via the terminal:
   ```bash
   sudo rpm -i dzlinux-1.3.1.x86_64.rpm
   ```
3. Launch from your app menu or run `dzlinux` in the terminal.
